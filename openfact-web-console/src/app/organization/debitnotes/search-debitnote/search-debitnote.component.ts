...
import { Organization, CreditNote, DataService, AlertService } from '../../../shared';
import { SearchCriteria, SearchCriteriaFilter, SearchCriteriaFilterOperator, SearchResults, Paging, OrderBy } from '../../../shared';

@Component({
  selector: 'app-search-debitnote',
  templateUrl: './search-debitnote.component.html',
  styleUrls: ['./search-debitnote.component.scss']
})
export class SearchDebitnoteComponent implements OnInit {

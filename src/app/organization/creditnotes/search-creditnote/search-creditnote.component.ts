...
import { Organization, DebitNote, DataService, AlertService } from '../../../shared';
import { SearchCriteria, SearchCriteriaFilter, SearchCriteriaFilterOperator, SearchResults, Paging, OrderBy } from '../../../shared';

@Component({
  selector: 'app-search-creditnote',
  templateUrl: './search-creditnote.component.html',
  styleUrls: ['./search-creditnote.component.scss']
})
export class SearchCreditnoteComponent implements OnInit {

   private organization: Organization;
  private searchResult: SearchResults<DebitNote> = new SearchResults<DebitNote>();
